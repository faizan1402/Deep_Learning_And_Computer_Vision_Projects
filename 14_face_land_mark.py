# -*- coding: utf-8 -*-
"""
Created on Sun Sep  6 21:39:27 2020
...
#load the image file
face_image = face_recognition.load_image_file('images/samples/irfan.jpg')
...
#save the image
pil_image.save("images/samples/irfan_landmarks.jpg")
