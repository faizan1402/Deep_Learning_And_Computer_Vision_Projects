# -*- coding: utf-8 -*-
"""
Created on Sun Nov 22 02:18:21 2020
...
image_to_detect = cv2.imread('images/testing/faizan_ahmad_unknown_3.jpg')
...
for index,current_face_location in enumerate(all_face_locations):
    ...
    cv2.rectangle(image_to_detect,(left_pos,top_pos),(right_pos,bottom_pos),(0,255,0),2)
    ...
    cv2.putText(image_to_detect, emotion_label, (left_pos,bottom_pos), font, 0.5, (0,255,255),2)
